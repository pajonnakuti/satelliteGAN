"""
86_spatial_chronos_only.py - Spatial Chronos-only with ConvLSTM-style outputs
==============================================================================
DESIGN:
  Runs Chronos on the target pixel per rolling window and reconstructs the full
  spatial field via beta_map propagation (same pattern as ConvLSTM-style outputs).
...
USAGE:
  ...
  CALIBRATE=0 POINT_ONLY=1 python 86_spatial_chronos_only.py
"""
import os
...
SCRIPT_NAME = Path(__file__).name if "__file__" in globals() else "86_spatial_chronos_only.py"
...
print("=" * 80)
print(f"{SCRIPT_NAME} | Chronos-only")
